(function (factory) {
    ...
    (function ($, undef) {
        ...
        var canSetInputAttribute = function () {
            ...
            catch (e) { result = false } body.removeChild(input);
            return result
        }();
        var defaults = {
            show: "infer",
            ...
            wrapper: {
                ...
                enforceWidth: true, styles: { position: "relative" },
        ...
        HideShowPassword.prototype = {
                    ...
                    if (!$.isArray(options.toggle.attachToKeyCodes)) {
                        if (options.toggle.attachToKeyCodes === true) {
                            ...
                            switch (testElement.prop("tagName").toLowerCase()) {
                                case "button": case "input": break; case "a":
            ...
            positionToggle: function (position, verticalAlign, offset) {
                ...
                switch (verticalAlign) {
                    case "top": case "bottom": styles[verticalAlign] = offset;
                        break;
                    case "middle": styles.top = "50%"; styles.marginTop = this.toggleElement.outerHeight() / -2;
                        break
                }
